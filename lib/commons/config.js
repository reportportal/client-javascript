...
const getOAuthConfig = (options) => {
  ...
  if (!tokenEndpoint) {
    throw new ReportPortalRequiredOptionError('tokenEndpoint');
  }
  if (!username) {
    throw new ReportPortalRequiredOptionError('username');
  }
  if (!password) {
    throw new ReportPortalRequiredOptionError('password');
  }
  if (!clientId) {
    throw new ReportPortalRequiredOptionError('clientId');
  }
