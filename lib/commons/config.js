...
const { MAX_LOG_BATCH_SIZE, MAX_LOG_BATCH_PAYLOAD_SIZE } = require('../logs/constants');
...
const getPositiveNumberOption = (options, optionName, defaultValue) => {
...
const getClientConfig = (options) => {
  ...
  try {
    ...
    calculatedOptions = {
      ...
      batchLogsSize: getPositiveNumberOption(options, 'batchLogsSize', MAX_LOG_BATCH_SIZE),
      batchPayloadLimit: getPositiveNumberOption(
        options,
        'batchPayloadLimit',
