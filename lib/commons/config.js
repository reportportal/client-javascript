...
const getClientConfig = (options) => {
  ...
  try {
    ...
    calculatedOptions = {
      ...
      truncateAttributes: options.truncateAttributes !== false,
      truncateFields: options.truncateFields !== false,
      replaceBinaryChars: options.replaceBinaryChars !== false,
      launchNameLengthLimit: options.launchNameLengthLimit || LAUNCH_NAME_LENGTH_LIMIT,
      itemNameLengthLimit: options.itemNameLengthLimit || ITEM_NAME_LENGTH_LIMIT,
      launchDescriptionLengthLimit:
        options.launchDescriptionLengthLimit || LAUNCH_DESCRIPTION_LENGTH_LIMIT,
      itemDescriptionLengthLimit:
        options.itemDescriptionLengthLimit || ITEM_DESCRIPTION_LENGTH_LIMIT,
    };
  } catch (error) {
