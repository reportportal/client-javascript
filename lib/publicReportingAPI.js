...
class PublicReportingAPI {
  ...
  /**
   * Emit add parameters event.
   * @param {Array} parameters - array of parameters, should looks like this:
   * [{
   *      key: "paramKey",
   *      value: "paramValue",
   * }]
   */
  static addParameters(parameters) {
    process.emit(EVENTS.ADD_PARAMETERS, { parameters });
  }
}
